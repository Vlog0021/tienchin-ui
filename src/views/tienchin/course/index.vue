<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="课程编号" align="center" :show-overflow-tooltip="true" width="90" prop="courseId"/>
            ...
            <el-table-column label="适用人群" align="center" width="120">
                <template #default="scope">
                    <dict-tag :options="course_apply_to" :value="scope.row.applyTo"/>
                </template>
            </el-table-column>
            <el-table-column label="课程简介" align="center" :show-overflow-tooltip="true" width="200" prop="info"/>
            <!-- <el-table-column label="课程备注" align="center" :show-overflow-tooltip="true" width="150" prop="remark"/> -->
        ...
        <!-- 添加或修改课程对话框 -->
        <el-dialog :title="title" v-model="open" width="565px" append-to-body>
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="课程价格" prop="price">
                            <el-input-number style="width: 100%" v-model="form.price" placeholder="请输入课程价格"
...
const data = reactive({
    ...
    rules: {
        type: [{required: true, message: "课程类型为必填项", trigger: "blur"}],
        name: [{required: true, message: "课程名称为必填项", trigger: "blur"}],
        applyTo: [{required: true, message: "使用人群为必填项", trigger: "blur"}],
        price: [{required: true, message: "课程价格为必填项", trigger: "blur"}],
        info: [{required: true, message: "课程简介为必填项", trigger: "blur"}]
    }
});
