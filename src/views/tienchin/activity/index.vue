<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="activityList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="活动编号" align="center" :show-overflow-tooltip="true" width="77" prop="activityId"/>
            <el-table-column label="活动名称" align="center" :show-overflow-tooltip="true" width="80" prop="name"/>
            <el-table-column label="渠道名称" align="center" :show-overflow-tooltip="true" width="100" prop="channelName"/>
            <el-table-column label="活动简介" align="center" :show-overflow-tooltip="true" width="100" prop="info"/>
            <el-table-column label="活动类型" align="center" width="80">
                <template #default="scope">
                    <dict-tag :options="activity_type" :value="scope.row.type"/>
                </template>
            </el-table-column>
            <el-table-column label="活动明细" :show-overflow-tooltip="true" align="center" width="107">
                <template #default="scope">
            ...
            <el-table-column label="活动状态" align="center" width="77">
                <template #default="scope">
                    <dict-tag :options="activity_status" :value="scope.row.status"/>
                </template>
            </el-table-column>
            <el-table-column label="活动开始时间" align="center" prop="beginTime" width="155">
                <template #default="scope">
