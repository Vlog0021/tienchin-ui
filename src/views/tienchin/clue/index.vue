<template>
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="clueList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="线索编号" align="center" :show-overflow-tooltip="true" width="90" prop="clueId"/>
            ...
            <el-table-column label="渠道来源" align="center" :show-overflow-tooltip="true" width="120"
                             prop="channelName"/>
            ...
            <el-table-column label="线索状态" align="center" width="120">
                <template #default="scope">
                    <dict-tag :options="clue_status" :value="scope.row.status"/>
                </template>
            </el-table-column>
            <el-table-column label="下次跟进时间" align="center" prop="nextTime" width="160">
                <template #default="scope">
        ...
        />
        <!-- 分配对话框 -->
        <el-dialog title="分配线索" v-model="assignClueDialog" width="600px" append-to-body>
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="客户年龄" prop="age">
                            <el-input-number v-model="form.age" :min="1" :max="100" placeholder="年龄"/>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="微信号" prop="wechat">
                            <el-input v-model="form.wechat" placeholder="请输入客户微信号码"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="QQ" prop="qq">
                            <el-input v-model="form.qq"
                                      placeholder="请输入客户QQ号码"/>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
...
import { listUsers, listChannels, listActivity, addClue, listClue, treeselect, assignClue, getClueSummaryById, updateClue, delClue } from "@/api/tienchin/clue";
...
const data = reactive({
    ...
    rules: {
        phone: [{required: true, message: "客户电话为必填项", trigger: "blur"}],
        name: [{required: true, message: "客户姓名为必填项", trigger: "blur"}],
    },
    assignFormRules: {
        departmentId: [{required: true, message: "部门 ID 为必填项", trigger: "blur"}],
