<template>
    <div class="app-container">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button
                            ...
                            v-hasPermi="['TienChin:business:view']"
                    >查看
                    </el-button>
                    <el-button
                            ...
                            v-hasPermi="['TienChin:business:assignment']"
                    >分配
                    </el-button>
                    <el-button
                            ...
                            v-hasPermi="['TienChin:business:follow']"
                    >跟进
                    </el-button>
                </template>
            </el-table-column>
        ...
        />
        <!-- 分配对话框 -->
        <el-dialog title="分配线索" v-model="assignBusinessDialog" width="600px" append-to-body>
...
import { listUsers, treeselect, getClueSummaryById, updateClue, delClue } from "@/api/tienchin/business";
...
function handleUpdate(row) {
    ...
    getClueSummaryById(businessId).then(response => {
...
function handleDelete(row) {
    ...
    proxy.$modal.confirm('是否确认删除线索编号为"' + businessIds + '"的数据项？').then(function () {
        return delClue(businessIds);
    }).then(() => {
        getList();
